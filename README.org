...
[[./info-nav.webm]]
(Right-click to show video controls for now.)

#+begin_export html
<!--
<video controls>
  <source src="/ggxx/info-nav/raw/branch/master/info-nav.webm" type="video/webm" />
  <a href="/ggxx/info-nav/raw/branch/master/info-nav.webm">info-nav.webm</a>
</video>
-->
#+end_export
...
- Check out [[https://codeberg.org/ggxx/nfo][nfo]].
